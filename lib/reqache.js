...
function fetch(url) {
  ...
  var request = setFetchResponseType((0, _whatwgFetch.fetch)(url, options), responseType);
  ...
  if (!cache[url]) {
    request.then(function (result) {
      return cache.setItem(url, _jsonify2["default"].stringify(result));
    });
  }
...
var _Reqache = __webpack_require__(/*! ./Reqache.js */ "./src/Reqache.js");

var _Reqache2 = _interopRequireDefault(_Reqache);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

exports.fetch = _Reqache2["default"];
